...
<style>
    ...
    .sidebar {
        ...
        /* Lebar dasar */
        min-width: 260px;
        /* PENTING: Mencegah sidebar mengecil saat konten kanan lebar */
        height: 100vh;
        /* Tinggi sepenuh layar */
        background: #ffffff;
        ...
        flex-shrink: 0;
        /* PENTING: Mencegah sidebar 'gepeng' */
        z-index: 100;
        /* Agar selalu di atas jika ada elemen numpuk */
    }
    ...
    .submenu .menu-item {
        ...
        /* Memberi jarak menjorok ke dalam */
        font-size: 0.9rem;
    ...
    .submenu .menu-item i {
        font-size: 0.85rem;
        width: 20px;
        /* Lebar tetap agar teks di sebelahnya lurus rapi */
        text-align: center;
        /* Icon di tengah kotaknya sendiri */
        margin-right: 12px;
        /* Jarak antara icon dan teks */
        flex-shrink: 0;
        /* Mencegah icon gepeng */
        opacity: 0.75;
    }
...
<aside class="sidebar d-none d-md-flex flex-column">
    ...
    <nav class="flex-grow-1 p-3 overflow-auto">
        ...
        <div id="arsipDinamis" class="submenu <?= $arsip_active ? '' : 'd-none' ?>">
            ...
            <a href="<?= $base_url ?>arsip-vital.php"
                class="menu-item <?= strpos($current_file, 'arsip-vital') !== false ? 'active' : '' ?>">
                <i class="fas fa-file-alt"></i>
                <span>Arsip Vital</span>
            </a>

            <a href="<?= $base_url ?>arsip-permanen.php"
                class="menu-item <?= strpos($current_file, 'arsip-permanen') !== false ? 'active' : '' ?>">
                <i class="fas fa-file-alt"></i>
                <span>Arsip Permanen</span>
            </a>

            <a href="<?= $base_url ?>arsip-aktif.php"
                class="menu-item <?= $current_file == 'arsip-aktif.php' ? 'active' : '' ?>">
                <i class="fas fa-file-alt"></i>
                <span>Arsip Aktif</span>
            </a>

            <a href="<?= $base_url ?>arsip-inaktif.php"
                class="menu-item <?= $current_file == 'arsip-inaktif.php' ? 'active' : '' ?>">
                <i class="fas fa-file-alt"></i>
